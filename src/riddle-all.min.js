...
(function(m,o,e){function f(a,c){if(typeof a==="string")return n(a,c,"querySelectorAll");else if(a instanceof HTMLElement)return i(l(a));else if(typeof a==="function")s?a(f):m.addEventListener("DOMContentLoaded",function(){a(f)},false)}function n(a,c,d){if(typeof c==="undefined"||c instanceof HTMLElement)return i(l((c||m)[d](a)));else if(c.__proto__===f.fn){var j=[];c.map(function(k){return l(k[d](a))}).forEach(function(k){k.forEach(function(t){j.push(t)})});return i(j)}}function l(a){if(a===null)return[];
else if(a instanceof HTMLElement)return[a];else if(typeof a.length==="number"&&typeof a.item==="function")return o.call(a)}function i(a){a.__proto__=f.fn;return a}function b(a,c){var d,j=c||"last";if(typeof a==="string")this.forEach(function(k){b[j](k,a)});else if(a instanceof HTMLElement){d=a.outerHTML;this.forEach(function(k){b[j](k,d)})}else if(a.__proto__===f.fn){d=a.map(function(k){return k.outerHTML}).join("");this.forEach(function(k){b[j](k,d)})}return this}function g(a,c){return a.filter(function(d){return d.event===
c})}function h(a){var c=[],d;for(d in a)c.push(e(d)+"="+e(a[d]));return"?"+c.join("&")}var p={},q=1,s=false;f.fn={detect:function(a){return this.filter(a)[0]},invoke:function(){var a=o.call(arguments),c=a.shift();return this.map(function(d){return d[c].apply(d,a)})},pluck:function(a){return this.map(function(c){return c[a]})},each:function(a){return this.forEach(function(c){a(i(l(c)))})},html:function(a){var c;if(typeof a==="undefined")return this.length===1?this[0].innerHTML:this.pluck("innerHTML").map(function(d){return d});
...
this.forEach(function(d){d.style.setProperty(a,c,"")});else typeof a==="object"&&this.forEach(function(d){for(var j in a)a[j]===null?d.style.removeProperty(j):d.style.setProperty(j,a[j],"")});return this},addClass:function(a){this.forEach(function(c){c.className===""?c.className=a:c.className+=" "+a});return this},removeClass:function(a){var c=RegExp("(?:^|\\b)"+a+"(?:\\b|$)\\s?","g");this.forEach(function(d){var j=d.className.replace(c,"");d.className=j.replace(/\s+$/,"")});return this},hasClass:function(a){var c=
RegExp("(?:^|\\b)"+a+"(?:\\b|$)");return this.length===1?!!this[0].className.match(c):this.map(function(d){return!!d.className.match(c)})},swapClass:function(a,c){this.removeClass(a);this.addClass(c)},bind:function(a,c,d){this.forEach(function(j){var k=j.nid||(j.nid=q++);k=p[k]||(p[k]=[]);k.push({event:a,callback:c,index:k.length});j.addEventListener(a,c,d||false)});return this},unbind:function(a){this.forEach(function(c){var d=c.nid||(c.nid=q++),j=a?g(p[d],a):p[d];j&&j.forEach(function(k){delete j[k.index];
...
c)};f.id=function(a,c){return n(a,c,"getElementById")};f.cls=function(a,c){return n(a,c,"getElementsByClassName")};f.tag=function(a,c){return n(a,c,"getElementsByTagName")};f.ajax=function(a,c,d,j){var k=new XMLHttpRequest;j=j||{};d=d||function(){};var t=j.header||{},w=j.ctype||(j.method==="POST"?"application/x-www-form-urlencoded":""),u=j.data||"",v;k.onreadystatechange=function(){if(k.readyState===4)k.status>=200&&k.status<300?c(k.responseText,k):d(k)};if(typeof u==="object")u=h(u);k.open(j.method||
"GET",a,true);w&&k.setRequestHeader("Content-Type",w);k.setRequestHeader("X-Requested-With","XMLHttpRequest");for(v in t)k.setRequestHeader(v,t[v]);k.send(u)};f.version="0.2.6";window.r=f})(document,Array.prototype.slice,encodeURIComponent);(function(){function m(b){b=b.css("-webkit-transform").match(/matrix\([\-\d.]+,\s[\-\d.]+,\s[\-\d.]+,\s[\-\d.]+,\s([\-\d.]+),\s([\-\d.]+)\)/);return b!==null&&b.length===3?{x:Number(b[1]),y:Number(b[2])}:{x:0,y:0}}function o(b){b=b.css("-webkit-transform").match(/matrix\(([\d.]+),\s[\d.]+,\s[\d.]+,\s([\d.]+),\s[\d.]+,\s[\d.]+\)/);return b!==null&&b.length===3?{x:Number(b[1]),y:Number(b[2])}:{x:1,y:1}}function e(b,g,h){var p="0.3s",q="ease-in-out",s,a=0,c={};if(g instanceof Array){c["-webkit-transform"]=
...
h)};r.fn.scaleX=function(b,g){var h=o(this);this.animate(["scale("+b+","+h.y+")"],g)};r.fn.scaleRX=function(b,g){var h=o(this);this.animate(["scale("+h.x*b+","+h.y+")"],g)};r.fn.scaleY=function(b,g){this.animate(["scale("+o(this).x+","+yScale+")"],g)};r.fn.scaleRY=function(b,g){var h=o(this);this.animate(["scale("+h.x+","+h.y*b+")"],g)};r.fn.move=function(b,g,h){if(typeof b==="number"&&typeof g==="number")this.animate([l+b+"px,"+g+"px"+i],h);else typeof b==="string"&&typeof g==="string"&&this.animate([l+
b+","+g+i],h)};r.fn.moveR=function(b,g,h){var p=m(this);this.animate([l+(p.x+b)+"px,"+(p.y+g)+"px"+i],h)};r.fn.moveX=function(b,g){var h=m(this);if(typeof b==="number")this.animate([l+b+"px,"+h.y+"px"+i],g);else typeof b==="string"&&this.animate([l+b+","+h.y+i],g)};r.fn.moveRX=function(b,g,h){g=m(this);this.animate([l+(g.x+b)+"px,"+g.y+"px"+i],h)};r.fn.moveY=function(b,g){var h=m(this);if(typeof b==="number")this.animate([l+h.x+"px,"+b+"px"+i],g);else typeof b==="string"&&this.animate([l+h.x+"px,"+
b+i],g)};r.fn.moveRY=function(b,g){var h=m(this);this.animate([l+h.x+"px,"+(h.y+b)+"px"+i],g)};r.fn.fadeIn=function(b){this.animate({opacity:1},b)};r.fn.fadeOut=function(b){this.animate({opacity:0},b)};r.fn.show=function(b){this.animate({visibility:"visible"},b)};r.fn.hide=function(b){this.animate({visibility:"hidden"},b)}})();(function(m,o,e){function f(i,b){var g=b;if(typeof i!=="function")throw Error("First parameter should be function");if(typeof b==="undefined")throw Error("Second parameter should not be undefined");this.forEach(function(h){g=i(g,h)});return g}function n(){return this.replace(/(^\s+)|(\s+$)/g,"")}function l(i){return eval("("+i+")")}if(typeof o.reduce!=="function")o.reduce=f;if(typeof e.trim!=="function")e.trim=n;if(typeof m.JSON!=="object"){m.JSON={};m.JSON.parse=l}})(window,Array.prototype,String.prototype);(function(m,o,e){m.r.load=function(f,n){var l=0,i=f.length;f.forEach(function(b){var g=o.createElement("script");g.src=b;g.onload=function(){g.removeAttribute("onload");++l===i&&n()};e.appendChild(g)})}})(window,document,document.getElementsByTagName("head")[0]);(function(){function m(e){this.storage=e}function o(e){return o.sname||(o.sname=new m(window[e+"Storage"]))}m.prototype.set=function(e,f){if(typeof e==="number"||typeof e==="string")this.storage.setItem(e,JSON.stringify(f));else if(typeof f==="undefined")throw Error("typeof value is 'undefined'. Maybe you're doing something wrong");else throw Error("Given value as key is OK but seems not a good manner");};m.prototype.get=function(e){return typeof this.storage[e]==="undefined"?null:JSON.parse(this.storage.getItem(e))};
