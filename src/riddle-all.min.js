...
b,i=0,h={};d instanceof Array?(h["-webkit-transform"]=d.join(" "),b=1):typeof d==="object"&&(b=f(d,h));if(typeof c==="object"){typeof c.duration==="string"?e=c.duration:typeof c.duration==="number"&&(e=c.duration+"s");if(typeof c.easing==="string")g=c.easing;typeof c.callback==="function"&&a.bind("webkitTransitionEnd",function(d){++i;b===i&&(c.callback(d),a.unbind("webkitTransitionEnd"))})}h["-webkit-transition"]=e+" "+g;h["-webkit-backface-visibility"]="hidden";h["-webkit-perspective"]="1000";h["-webkit-transform-origin"]=
"0 0";a.css(h)}function f(a,d){var c,f=0;for(c in a)d[c]=a[c],f++;return f}var k="WebKitCSSMatrix"in window&&"m11"in new WebKitCSSMatrix,i="translate"+(k?"3d(":"("),h=k?",0)":")";r.fn.animate=function(a,d){var c=0,f=this.length,e=d||{},b=typeof e.callback==="function"?e.callback:function(){};e.callback=function(){++c;c===f&&b()};this.each(function(c){g(c,a,e)})};r.fn.scale=function(a,d,c){this.animate(["scale("+a+","+d+")"],c)};r.fn.scaleR=function(a,d,c){var f=j(this);this.animate(["scale("+f.x*
a+","+f.y*d+")"],c)};r.fn.scaleX=function(a,d){var c=j(this);this.animate(["scale("+a+","+c.y+")"],d)};r.fn.scaleRX=function(a,d){var c=j(this);this.animate(["scale("+c.x*a+","+c.y+")"],d)};r.fn.scaleY=function(a,d){this.animate(["scale("+j(this).x+","+yScale+")"],d)};r.fn.scaleRY=function(a,d){var c=j(this);this.animate(["scale("+c.x+","+c.y*a+")"],d)};r.fn.move=function(a,d,c){typeof a==="number"&&typeof d==="number"?this.animate([i+a+"px,"+d+"px"+h],c):typeof a==="string"&&typeof d==="string"&&
this.animate([i+a+","+d+h],c)};r.fn.moveR=function(a,d,c){var f=e(this);this.animate([i+(f.x+a)+"px,"+(f.y+d)+"px"+h],c)};r.fn.moveX=function(a,d){var c=e(this);typeof a==="number"?this.animate([i+a+"px,"+c.y+"px"+h],d):typeof a==="string"&&this.animate([i+a+","+c.y+h],d)};r.fn.moveRX=function(a,d,c){d=e(this);this.animate([i+(d.x+a)+"px,"+d.y+"px"+h],c)};r.fn.moveY=function(a,d){var c=e(this);typeof a==="number"?this.animate([i+c.x+"px,"+a+"px"+h],d):typeof a==="string"&&this.animate([i+c.x+"px,"+
