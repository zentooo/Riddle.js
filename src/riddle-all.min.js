...
(function(f,g,d){function c(a,e){if(typeof a==="string")return l(a,e,"querySelectorAll");else if(a instanceof Array)return i(a);else if(typeof a.addEventListener==="function")return i(j(a));else typeof a==="function"&&(o?a(c):f.addEventListener("DOMContentLoaded",function(){a(c)},!1))}function l(a,e,b){var h=[];if(e===void 0||e instanceof HTMLElement)return i(j((e||f)[b](a)));else if(c.isR(e))return e.map(function(h){return j(h[b](a))}).forEach(function(b){b.forEach(function(b){h.push(b)})}),i(h)}
function j(a){if(a===null||a===void 0)return[];else if(a instanceof HTMLElement)return[a];else if(typeof a.length==="number"&&typeof a.item==="function")return g.call(a)}function i(a){a.__proto__=c.fn;return a}var m={},n=1,o=!1;f.addEventListener("DOMContentLoaded",function(){o=!0},!1);c.fn={detect:function(a){return this.filter(a)[0]},invoke:function(){var a=g.call(arguments),e=a.shift();return this.map(function(b){return b[e].apply(b,a)})},pluck:function(a){return this.map(function(e){return e[a]})},
