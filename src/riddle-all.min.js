...
(function(m,o,e){function f(a,c){if(typeof a==="string")return n(a,c,"querySelectorAll");else if(a instanceof HTMLElement)return j(l(a));else if(typeof a==="function")s?a(f):m.addEventListener("DOMContentLoaded",function(){a(f)},false)}function n(a,c,d){if(typeof c==="undefined"||c instanceof HTMLElement)return j(l((c||m)[d](a)));else if(c.__proto__===f.fn){var k=[];c.map(function(i){return l(i[d](a))}).forEach(function(i){i.forEach(function(t){k.push(t)})});return j(k)}}function l(a){if(a===null)return[];
else if(a instanceof HTMLElement)return[a];else if(typeof a.length==="number"&&typeof a.item==="function")return o.call(a)}function j(a){a.__proto__=f.fn;return a}function b(a,c){var d,k=c||"last";if(typeof a==="string")this.forEach(function(i){b[k](i,a)});else if(a instanceof HTMLElement){d=a.outerHTML;this.forEach(function(i){b[k](i,d)})}else if(a.__proto__===f.fn){d=a.map(function(i){return i.outerHTML}).join("");this.forEach(function(i){b[k](i,d)})}return this}function g(a,c){return a.filter(function(d){return d.event===
...
a);else c===null?this.invoke("removeAttribute",a):this.invoke("setAttribute",a,String(c));else typeof a==="object"&&this.forEach(function(d){for(var k in a)a[k]===null?d.removeAttribute(k):d.setAttribute(k,String(a[k]))});return this},css:function(a,c){if(typeof a==="string")if(typeof c==="undefined")return this.length===1?getComputedStyle(this[0],"").getPropertyValue(a):this.map(function(d){return getComputedStyle(d,"").getPropertyValue(a)});else c===null?this.forEach(function(d){d.style.removeProperty(a)}):
this.forEach(function(d){d.style.setProperty(a,c,"")});else typeof a==="object"&&this.forEach(function(d){var k=";",i;for(i in a)if(a[i]===null)d.style.removeProperty(i);else k+=i+":"+a[i]+";";d.style.cssText+=k});return this},addClass:function(a){this.forEach(function(c){c.className===""?c.className=a:c.className+=" "+a});return this},removeClass:function(a){var c=RegExp("(?:^|\\b)"+a+"(?:\\b|$)\\s?","g");this.forEach(function(d){var k=d.className.replace(c,"");d.className=k.replace(/\s+$/,"")});
return this},hasClass:function(a){var c=RegExp("(?:^|\\b)"+a+"(?:\\b|$)");return this.length===1?!!this[0].className.match(c):this.map(function(d){return!!d.className.match(c)})},swapClass:function(a,c){this.removeClass(a);this.addClass(c)},bind:function(a,c,d){this.forEach(function(k){var i=k.nid||(k.nid=q++);i=p[i]||(p[i]=[]);i.push({event:a,callback:c,index:i.length});k.addEventListener(a,c,d||false)});return this},unbind:function(a){this.forEach(function(c){var d=c.nid||(c.nid=q++),k=a?g(p[d],
a):p[d];k&&k.forEach(function(i){delete k[i.index];c.removeEventListener(i.event,i.callback,false)})});return this}};m.addEventListener("DOMContentLoaded",function(){s=true},false);["click","submit","focus","blur","scroll","select","change"].forEach(function(a){f.fn[a]=function(c,d){this.bind(a,c,d)}});f.fn.__proto__=Array.prototype;b.prev=function(a,c){a.insertAdjacentHTML("beforeBegin",c)};b.first=function(a,c){a.insertAdjacentHTML("afterBegin",c)};b.last=function(a,c){a.insertAdjacentHTML("beforeEnd",
c)};b.next=function(a,c){a.insertAdjacentHTML("afterEnd",c)};f.id=function(a,c){return n(a,c,"getElementById")};f.cls=function(a,c){return n(a,c,"getElementsByClassName")};f.tag=function(a,c){return n(a,c,"getElementsByTagName")};f.ajax=function(a,c,d,k){var i=new XMLHttpRequest;k=k||{};c=c||function(){};d=d||function(){};var t=k.method||"GET",v=k.header||{},w=k.ctype||(t==="POST"?"application/x-www-form-urlencoded":"");k=k.data||"";var u;i.onreadystatechange=function(){if(i.readyState===4)i.status>=
200&&i.status<300?c(i.responseText,i):d(i)};if(typeof k==="object")k=h(k);i.open(t,a,true);w&&i.setRequestHeader("Content-Type",w);i.setRequestHeader("X-Requested-With","XMLHttpRequest");for(u in v)i.setRequestHeader(u,v[u]);i.send(k)};f.version="0.2.7";window.r=f})(document,Array.prototype.slice,encodeURIComponent);(function(){function m(b){b=b.css("-webkit-transform");b=typeof b==="string"?b.match(/matrix\([\-\d.]+,\s[\-\d.]+,\s[\-\d.]+,\s[\-\d.]+,\s([\-\d.]+),\s([\-\d.]+)\)/):null;return b!==null&&b.length===3?{x:Number(b[1]),y:Number(b[2])}:{x:0,y:0}}function o(b){b=b.css("-webkit-transform");b=typeof b==="string"?b.match(/matrix\(([\d.]+),\s[\d.]+,\s[\d.]+,\s([\d.]+),\s[\d.]+,\s[\d.]+\)/):null;return b!==null&&b.length===3?{x:Number(b[1]),y:Number(b[2])}:{x:1,y:1}}function e(b,g,h){var p="0.3s",q="ease-in-out",
s,a=0,c={};if(g instanceof Array){c["-webkit-transform"]=g.join(" ");s=1}else if(typeof g==="object")s=f(g,c);if(typeof h==="object"){if(typeof h.duration==="string")p=h.duration;else if(typeof h.duration==="number")p=h.duration+"s";if(typeof h.easing==="string")q=h.easing;typeof h.callback==="function"&&b.bind("webkitTransitionEnd",function(d){++a;if(s===a){h.callback(d);b.unbind("webkitTransitionEnd")}})}c["-webkit-transition"]=p+" "+q;c["-webkit-backface-visibility"]="hidden";c["-webkit-perspective"]=
"1000";c["-webkit-transform-origin"]="0 0";b.css(c)}function f(b,g){var h,p=0;for(h in b){g[h]=b[h];p++}return p}var n="WebKitCSSMatrix"in window&&"m11"in new WebKitCSSMatrix,l="translate"+(n?"3d(":"("),j=n?",0)":")";r.fn.animate=function(b,g){var h=0,p=this.length,q=g||{},s=typeof q.callback==="function"?q.callback:function(){};q.callback=function(){++h;h===p&&s()};this.each(function(a){e(a,b,q)})};r.fn.scale=function(b,g,h){this.animate(["scale("+b+","+g+")"],h)};r.fn.scaleR=function(b,g,h){var p=
o(this);this.animate(["scale("+p.x*b+","+p.y*g+")"],h)};r.fn.scaleX=function(b,g){var h=o(this);this.animate(["scale("+b+","+h.y+")"],g)};r.fn.scaleRX=function(b,g){var h=o(this);this.animate(["scale("+h.x*b+","+h.y+")"],g)};r.fn.scaleY=function(b,g){this.animate(["scale("+o(this).x+","+yScale+")"],g)};r.fn.scaleRY=function(b,g){var h=o(this);this.animate(["scale("+h.x+","+h.y*b+")"],g)};r.fn.move=function(b,g,h){if(typeof b==="number"&&typeof g==="number")this.animate([l+b+"px,"+g+"px"+j],h);else typeof b===
"string"&&typeof g==="string"&&this.animate([l+b+","+g+j],h)};r.fn.moveR=function(b,g,h){var p=m(this);this.animate([l+(p.x+b)+"px,"+(p.y+g)+"px"+j],h)};r.fn.moveX=function(b,g){var h=m(this);if(typeof b==="number")this.animate([l+b+"px,"+h.y+"px"+j],g);else typeof b==="string"&&this.animate([l+b+","+h.y+j],g)};r.fn.moveRX=function(b,g,h){g=m(this);this.animate([l+(g.x+b)+"px,"+g.y+"px"+j],h)};r.fn.moveY=function(b,g){var h=m(this);if(typeof b==="number")this.animate([l+h.x+"px,"+b+"px"+j],g);else typeof b===
"string"&&this.animate([l+h.x+"px,"+b+j],g)};r.fn.moveRY=function(b,g){var h=m(this);this.animate([l+h.x+"px,"+(h.y+b)+"px"+j],g)};r.fn.fadeIn=function(b){this.animate({opacity:1},b)};r.fn.fadeOut=function(b){this.animate({opacity:0},b)};r.fn.show=function(b){this.animate({visibility:"visible"},b)};r.fn.hide=function(b){this.animate({visibility:"hidden"},b)}})();(function(m,o,e){function f(j,b){var g=b;if(typeof j!=="function")throw Error("First parameter should be function");if(typeof b==="undefined")throw Error("Second parameter should not be undefined");this.forEach(function(h){g=j(g,h)});return g}function n(){return this.replace(/(^\s+)|(\s+$)/g,"")}function l(j){return eval("("+j+")")}if(typeof o.reduce!=="function")o.reduce=f;if(typeof e.trim!=="function")e.trim=n;if(typeof m.JSON!=="object"){m.JSON={};m.JSON.parse=l}})(window,Array.prototype,String.prototype);(function(m,o,e){m.r.load=function(f,n){var l=0,j=f.length;f.forEach(function(b){var g=o.createElement("script");g.src=b;g.onload=function(){g.removeAttribute("onload");++l===j&&n()};e.appendChild(g)})}})(window,document,document.getElementsByTagName("head")[0]);(function(){function m(e){this.storage=e}function o(e){return o.sname||(o.sname=new m(window[e+"Storage"]))}m.prototype.set=function(e,f){if(typeof e==="number"||typeof e==="string")this.storage.setItem(e,JSON.stringify(f));else if(typeof f==="undefined")throw Error("typeof value is 'undefined'. Maybe you're doing something wrong");else throw Error("Given value as key is OK but seems not a good manner");};m.prototype.get=function(e){return typeof this.storage[e]==="undefined"?null:JSON.parse(this.storage.getItem(e))};
