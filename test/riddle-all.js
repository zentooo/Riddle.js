...
(function(global, doc, toArray, enc) {
        ...
        */
        removeClass: function(name) {
            this.forEach(function(elem) {
                ...
                el.className = currents.filter(function(c) {
                    return c !== className;
                }).join(" ");
            });
            return this;
...
})(window, document, Array.prototype.slice, encodeURIComponent);
...
(function() {
    ...
    */
    ...
    r.fn._getStructs = function(namespace) {
        var structs = [], current = [];
